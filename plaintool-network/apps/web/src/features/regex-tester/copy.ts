...
const texts = {
  en: {
    ...
    feature: {
      ...
      replacementPlaceholder: "For example: $1 (match)",
      replacementSample: "$1 (match)",
  ...
  ko: {
    ...
    feature: {
      ...
      replacementPlaceholder: "예: $1 (일치)",
      replacementSample: "$1 (일치)",
  ...
  es: {
    ...
    feature: {
      ...
      replacementPlaceholder: "Por ejemplo: $1 (coincidencia)",
      replacementSample: "$1 (coincidencia)",
  ...
  de: {
    ...
    feature: {
      ...
      replacementPlaceholder: "Zum Beispiel: $1 (Treffer)",
      replacementSample: "$1 (Treffer)",
  ...
  ja: {
    ...
    feature: {
      ...
      replacementPlaceholder: "例：$1（一致）",
      replacementSample: "$1（一致）",
  ...
  fr: {
    ...
    feature: {
      ...
      replacementPlaceholder: "Par exemple : $1 (correspondance)",
      replacementSample: "$1 (correspondance)",
  ...
  "pt-BR": {
    ...
    feature: {
      ...
      replacementPlaceholder: "Por exemplo: $1 (correspondência)",
      replacementSample: "$1 (correspondência)",
  ...
  it: {
    ...
    feature: {
      ...
      replacementPlaceholder: "Ad esempio: $1 (corrispondenza)",
      replacementSample: "$1 (corrispondenza)",
  ...
  nl: {
    ...
    feature: {
      ...
      replacementPlaceholder: "Bijvoorbeeld: $1 (overeenkomst)",
      replacementSample: "$1 (overeenkomst)",
  ...
  sv: {
    ...
    feature: {
      ...
      replacementPlaceholder: "Till exempel: $1 (träff)",
      replacementSample: "$1 (träff)",
  ...
  cs: {
    ...
    feature: {
      ...
      replacementPlaceholder: "Například: $1 (shoda)",
      replacementSample: "$1 (shoda)",
  ...
  pl: {
    ...
    feature: {
      ...
      replacementPlaceholder: "Na przykład: $1 (dopasowanie)",
      replacementSample: "$1 (dopasowanie)",
  ...
  da: {
    ...
    feature: {
      ...
      replacementPlaceholder: "For eksempel: $1 (match)",
      replacementSample: "$1 (match)",
  ...
  no: {
    ...
    feature: {
      ...
      replacementPlaceholder: "For eksempel: $1 (treff)",
      replacementSample: "$1 (treff)",
      replacementOutputLabel: "Erstattet resultat",
  ...
  ar: {
    ...
    feature: {
      ...
      replacementPlaceholder: "مثال: $1 (تطابق)",
      replacementSample: "$1 (تطابق)",
  ...
  "zh-TW": {
    ...
    feature: {
      ...
      replacementPlaceholder: "例如：$1（符合）",
      replacementSample: "$1（符合）",
  ...
  tr: {
    ...
    feature: {
      ...
      replacementPlaceholder: "Örneğin: $1 (eşleşme)",
      replacementSample: "$1 (eşleşme)",
