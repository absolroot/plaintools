...
const seed = {
  ui: {
    ...
    localBody:
      "لا يتم رفع إدخالك ونتائجك أو تخزينهما، بل يظلان في علامة تبويب المتصفح هذه.",
    guideTitle: "كيفية استخدام {name}",
    safetyTitle: "معالجة محلية وخاصة",
  ...
  pages: {
    ...
    "url-encode": {
      ...
      description:
        "ترمّز النصوص أو قيم الاستعلام أو عناوين URI الكاملة ترميزًا مئويًا وفق معيار المتصفح الصحيح.",
      guide:
