...
const seed = {
  ...
  pages: {
    ...
    "ai-watermark-remover": {
      title: "أداة إزالة الأحرف المخفية من النصوص",
      description:
        "يعثر على آثار Unicode المخفية الفعلية التي قد تُنسخ من GPT أو Claude أو ملفات PDF أو صفحات الويب ويزيلها. هذه الأداة لا تكشف ما إذا كان النص من تأليف الذكاء الاصطناعي.",
      guide:
    ...
    "hash-generator": {
      ...
      terms: ["SHA-256", "SHA-512", "MD5", "قيمة تحقق", "تجزئة ملف"],
    },
    "jwt-decoder": {
      title: "أداة فك JWT",
      description:
    ...
    "html-to-markdown": {
      ...
      terms: ["HTML إلى Markdown", "محول HTML", "Turndown"],
    },
    "markdown-to-html": {
