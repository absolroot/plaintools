...
const seed = {
  ...
  ai: {
    ...
    placeholder:
      "الصق نصًا منسوخًا قد يحتوي على أحرف غير مرئية غير مرغوب فيها.",
  ...
  pages: {
    ...
    "ai-watermark-remover": {
      title: "منظف نصوص الذكاء الاصطناعي",
      description:
        "ينظف الأحرف غير المرئية غير المرغوب فيها التي قد تختلط بالنص المنسوخ من ChatGPT أو Claude أو Gemini أو الويب. لا يحدد ما إذا كان النص مولدًا بالذكاء الاصطناعي، ولا يتجاوز أدوات الكشف أو يثبت مصدر النص.",
      guide:
      ...
      terms: [
        "منظف نصوص الذكاء الاصطناعي",
        "تنظيف النص المنسوخ من الذكاء الاصطناعي",
        "إزالة الأحرف غير المرئية من النص",
        "أحرف ChatGPT المخفية",
        "أحرف Claude المخفية",
        "أحرف Gemini المخفية",
        "إزالة العلامة المائية من النص",
      ],
    },
    "url-encode": {
    ...
    "jwt-decoder": {
      ...
      terms: ["فك ترميز JWT", "JSON Web Token", "حمولة JWT", "ترويسة JWT"],
    },
    "qr-code-generator": {
      title: "مولّد رمز QR",
      description:
