...
const seed = {
  ...
  imageResizer: imageResizerFor("pt-BR"),
  dateCalculator: dateCalculatorFor("pt-BR"),
  timeZoneConverter: timeZoneConverterFor("pt-BR"),
  calculatorSuite: calculatorSuiteFor("pt-BR"),
  uuidGenerator: uuidGeneratorFor("pt-BR"),
  ui: {
    clear: "Limpar",
    copy: "Copiar",
    download: "Baixar",
  ...
  ai: {
    ...
    output: "Texto limpo",
    placeholder:
      "Cole um texto copiado que possa conter caracteres invisíveis indesejados.",
  ...
  qr: {
    ...
    urlDialogBody:
      "Esta URL foi encontrada no código QR. Confira se ela é segura e pertence ao site esperado.",
    urlDialogDestination: "Endereço de destino",
    cancel: "Cancelar",
