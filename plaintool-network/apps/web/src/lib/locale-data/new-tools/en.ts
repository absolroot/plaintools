...
const seed = {
  ...
  imageResizer: imageResizerFor("en"),
  dateCalculator: dateCalculatorFor("en"),
  timeZoneConverter: timeZoneConverterFor("en"),
  calculatorSuite: calculatorSuiteFor("en"),
  ...
  qr: {
    ...
    formats: "PNG, JPEG, WebP, GIF, or BMP up to 10 MB",
