...
const seed = {
  ...
  pages: {
    "ai-watermark-remover": {
      ...
      description:
        "GPT、Claude、PDF、ウェブページなどからコピーした際に混入する、実在する非表示Unicode文字を検出して除去します。AIが書いた文章かどうかを判定するツールではありません。",
      guide:
    ...
    "url-encode": {
      title: "URLエンコーダー",
      description:
        "テキスト、クエリ値、完全なURIをブラウザー標準に従ってパーセントエンコードします。",
      guide:
    ...
    "url-decode": {
      title: "URLデコーダー",
      description:
        "パーセントエンコードされたURLやクエリ値をデコードします。回数を制限した複数回デコードにも対応します。",
      guide:
