...
const seed = {
  ...
  imageResizer: imageResizerFor("ja"),
  ...
  ai: {
    ...
    output: "クリーニング後のテキスト",
    placeholder:
      "不要な不可視文字が混ざる可能性のあるコピーした文章を貼り付けてください。",
    run: "非表示文字を除去",
    report: "除去レポート",
    removed: "除去した文字",
    normalized: "正規化した空白",
  ...
  pages: {
    ...
    "ai-watermark-remover": {
      title: "AIテキストクリーナー",
      description:
        "ChatGPT・Claude・GeminiやWebからコピーした文章に混ざる不要な不可視文字を見つけて整理します。AI生成の判定、検出ツールの回避、生成元の証明は行いません。",
      guide:
