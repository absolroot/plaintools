...
const bundle: LocaleBundle = {
  ...
  network: {
    ...
    directoryIntro:
      "로그인 없이 모든 도구를 무료로 사용하세요. 입력값과 결과는 서버에 저장되지 않습니다. 다음에도 바로 찾을 수 있도록 즐겨찾기에 추가해 두세요.",
    toolPromise: {
      improvement:
        "AbsolTools는 자주 쓰는 도구를 더 정확하고 편리하게 만듭니다.",
      privacy:
        "모든 도구는 무료이며 가입이 필요 없습니다. 작업은 브라우저에서 처리되고, 입력값과 결과는 서버에 저장되거나 전송되지 않습니다.",
      bookmark:
        "다음에도 바로 사용할 수 있도록 이 사이트를 즐겨찾기에 추가해 두세요.",
    },
