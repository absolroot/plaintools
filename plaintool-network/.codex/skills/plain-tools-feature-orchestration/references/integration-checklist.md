...
- `python scripts/qa-redesign.py --affected --changed-from <base>` for desktop/mobile browser behavior. Feature changes stay focused; shared UI changes automatically include the layout-risk locale matrix, RTL pages, and LTR technical inputs.
